...
Context API helps pass state from parent to child without prop drilling.
...
Application state - state that can be used and modified anywhere in the application
Component state - state that is only used and modified in the component it is created in

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

React-thunk makes redux asyncronus.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

Context API - quick setup and less code
